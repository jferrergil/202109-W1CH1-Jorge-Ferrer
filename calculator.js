...
let calcOperatorNum = document.getElementsByClassName('calc-btn-operator');
...
for(let i = 0; i < calcOperatorNum.length; i++){
    calcOperatorNum[i].addEventListener('click', performOperation, false);
}
